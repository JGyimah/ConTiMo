...
\begin{itemize}
	\item Create a static class in the namespace \textbf{static\_integration} which inherits from the class \textbf{public static\_base::StaticInterface}. NB: The feature id in your model must match your class name. For Example:
...
\begin{itemize}
	...
	\end{longlisting}
	\item \textbf{Encapsulate Feature As Plugin}
	\item \textbf{Register/Export Plugin}
\end{itemize}

\subsection{Implement a Dynamically Bound Feature}
\subsubsection{Dynamic Early}
\begin{itemize}
	\item \textbf{Encapsulate Feature As Plugin}
	\item \textbf{Register/Export Plugin}
\end{itemize}

\subsubsection{Dynamic Late}
\begin{itemize}
	\item \textbf{Encapsulate Feature As Plugin}
	\item \textbf{Register/Export Plugin}
\end{itemize}
