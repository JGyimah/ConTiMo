...
As indicated in Figure \ref{arch-over}, features modelled on the language layer can in turn be implemented on the source-code implementation layer as feature classes that form part of an internal feature repository, capable of execution to demonstrate a preferred capability.\\
\begin{itemize}
