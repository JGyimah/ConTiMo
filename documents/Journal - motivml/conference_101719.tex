...
In Table \ref{tab:realmecha}, we have highlighted some of such ROS based mechanisms which we used to realise static and dynamic binding in our application. These include, the C preprocessor or antenna\foot{http://antenna.sourceforge.net} that can be used to realise static binding, ROS pluginlib that can be used to realise dynamic binding and ROS parameters that can be used to realise both early and late time binding.
