...
Binding mechanisms are implementation techniques that provide our modelling language with the capability of variability. Modelled variation points of robots, that have been described and implemented with our language, leverage such variability techniques by integrating ROS based feature source-code packages into the framework in order to evaluate static, dynamic, early and late binding techniques in user defined programs.

The binding mechanisms present in our framework, were simulated with robust open source implementations that are compatible across a number of platforms. By utilising the capabilities of the C++ preprocessor and the ROS Pluginlib library, we were able to realise both static and dynamic feature binding.
\begin{itemize}
