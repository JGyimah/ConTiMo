...
The set of binding pairs indicated above can be generated through an expansion of all possible binding time values combined with all possible binding mode values assigned to a feature. The resultant attribute pairs made up of nine combinations, provide a high-level overview all possible binding states within the configuration space of a given mobile service robot. 
