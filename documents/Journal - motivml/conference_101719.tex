...
\begin{table}[htbp]
	...
	\begin{center}
		\begin{tabular}{|c|c|}
			...
			Static Late &  ROS Pluginlib + C++ Maps + ROS parameters  \\ \hline
			Dynamic Early &  ROS pluginlib + ROS parameters  \\ \hline
			Dynamic Late &  ROS pluginlib + ROS parameters  \\ \hline
...
Overall, the above mentioned syntax and semantic architectural designs can be verified through in-built mechanisms that prove model and implementation validity on a syntax and semantic level. Last but not least, validation mechanisms, namely we have included a schema checker and a constraint checker which have been designed to abstract the complexity of configuring valid models by parsing and validating model instances for correctness.
